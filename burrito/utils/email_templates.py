...
TEMPLATE__WAITING_TICKETS_EMAIL_NOTIFICATION = {
    "subject": "Тікети в статусі WAITING вже кілька днів",
    "content": """
Шановний(а) користувачу(ко),

Цим повідомленням нагадуємо, що наступні тікети перебувають у статусі "WAITING" протягом останніх {days_count} днів:

{data}

Будь ласка, зверніть увагу на зазначені тікети — адміністрація очікує на певні уточнення щодо них.
